...
st.markdown("""
    ...
    <h4 style="font-size: 18px; color: #FFFFFF; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8); text-align: center; margin: 5px 0;">Stay updated with all the headlines from the last five days. Last updated at 07:40, 04-02-25, pls.</h4>
""", unsafe_allow_html=True)
